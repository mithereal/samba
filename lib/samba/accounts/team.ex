defmodule Samba.Accounts.Team do
  ...
  actions do
    ...
    create :create do
      primary? true
      change Samba.Accounts.Team.Changes.AddUserTeam
      change Samba.Accounts.Team.Changes.AddTeamOwner
      change Samba.Accounts.Team.Changes.SwitchActorTeam
    end
  ...
  relationships do
    belongs_to :owner, Samba.Accounts.User do
