defmodule Samba.Accounts.UserGroup do
  use Ash.Resource,
  ...
  actions do
    ...
    create :sync do
      ...
      manual Samba.Accounts.UserGroup.Changes.SyncUserGroups
    end
  end
  ...
  relationships do
    belongs_to :group, Samba.Accounts.Group do
      description "Relationshp with a group inside a tenant"
      source_attribute :group_id
      allow_nil? false
    end

    belongs_to :user, Samba.Accounts.User do
