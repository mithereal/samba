defmodule Samba.Accounts.UserImpersonation do
  use Ash.Resource,
    otp_app: :samba,
  ...
  actions do
    ...
    action :stop_impersonation, :map do
      ...
      run Samba.Accounts.UserImpersonation.Actions.StopImpersonation
    end
  end
