  ...
  def render(assigns) do
    ...
    <% end %>
            ...
            <div class="w-full pt-4 border-t border-zinc-200 dark:border-zinc-800 text-xs space-y-1 text-indigo-600 dark:text-indigo-400">
              <div>
                <.link navigate={~p"/forum/profile/#{@user.username}/buddy/add"} class="hover:underline">
                  Add to your buddylist
                </.link>
              </div>
              <div>
                <.link navigate={~p"/forum/profile/#{@user.username}/ignore/add"} class="hover:underline">
                  Add to your ignore list
                </.link>
              </div>
              <div>
                <.link navigate={~p"/classifieds/profile/#{@user.username}/ignore/add"} class="hover:underline">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-y-2.5 text-sm">
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="text-xs mt-1">
                    <.link navigate={~p"/forum/search/#{@user.username}/posts"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div class="sm:col-span-2 text-xs">
                  <.link navigate={~p"/forum/search/#{@user.username}/topics"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div class="sm:col-span-2 text-xs">
                  ...
                  <div class="mt-0.5">
                    <.link navigate={~p"/forum/search/#{@user.username}/photos"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div class="sm:col-span-2 text-xs">
                  ...
                  <div class="mt-0.5">
                    <.link navigate={~p"/forum/search/#{@user.username}/photos/favorites"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div class="sm:col-span-2 text-xs">
                  ...
                  <div class="mt-1">
                    <.link navigate={~p"/classifieds/search/#{@user.username}"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div class="sm:col-span-2 text-xs">
                  <.link navigate={~p"/forum/search/#{@user.username}/feedback"} class="text-indigo-600 dark:text-indigo-400 hover:underline">
