      ...
      <div class="max-w-4xl mx-auto bg-white rounded-lg shadow overflow-hidden my-6">
        ...
        >
          ...
          <div class="divide-y divide-gray-200 bg-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-center">
              ...
              <div class="sm:col-span-2">
                <input
                  ...
                  name="facebook"
                  maxlength="255"
                  class="w-full sm:w-64 rounded-md border-gray-300 shadow-sm border p-2 text-sm"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-center">
              ...
              <div class="sm:col-span-2">
                <input
                  ...
                  name="website"
                  maxlength="255"
                  class="w-full sm:w-72 rounded-md border-gray-300 shadow-sm border p-2 text-sm"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              ...
              <div class="sm:col-span-2">
                <textarea
                  name="signature"
                  rows="6"
                  class="w-full rounded-md border-gray-300 shadow-sm border p-2 text-sm"
                ></textarea>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  {gettext(
                    "This block of text will be added to the bottom of every Classified Ad you post. Advertisers who have a lot of ads commonly use this for shipping or payment instructions. There is a 500 character limit"
                  )}
                </p>
              </div>
              <div class="sm:col-span-2">
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6">
            ...
            <p class="mt-1 text-xs text-gray-500">
              {gettext(
                "Display a small graphic image below your details in posts. Only one image can be displayed at a time, its width can be no greater than 100 pixels, the height no greater than 100 pixels, and the file size no more than 65KB."
              )}
            </p>
          </div>
          ...
          <div class="divide-y divide-gray-200 bg-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-center">
              ...
              <div class="sm:col-span-2 flex items-center space-x-4">
                <img
                  src="/vw/images/avatars/gallery/blank.gif"
                  alt="Avatar"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-center">
              <div class="text-sm font-medium text-gray-700">
                {gettext("Upload Avatar from your local PC:")}
              </div>
              <div class="sm:col-span-2">
                <input
                  type="file"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  {gettext(
                    "Enter the URL of the location of the Avatar image you wish to link, it will be copied to this site."
                  )}
                </p>
              </div>
              <div class="sm:col-span-2">
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 flex items-center justify-center space-x-4">
            <input
              ...
              name="submit"
              value="Submit"
              class="inline-flex justify-center rounded-md bg-blue-600 py-2 px-4 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
            />
            <input
              type="reset"
              value="Reset"
              name="reset"
              class="inline-flex justify-center rounded-md bg-white py-2 px-4 text-sm font-semibold text-gray-950 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 cursor-pointer"
            />
          </div>
        </.form>
      </div>
