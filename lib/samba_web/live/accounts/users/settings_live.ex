        ...
        >
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6">
            ...
            <p class="mt-1 text-xs text-gray-500">
              {gettext(
                "Some of the boxes below will not apply to you or may be confusing so if in doubt, leave the field(s) blank or at the default settings."
              )}
            </p>
          </div>
          ...
          <div class="divide-y divide-gray-200 bg-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  {gettext(
                    "Note: If you are changing your email on the site, this could break your classifieds feedback link.  If you have a feedback thread, please"
                  )}
                  <a
                    href="mailto:everettb@thesamba.com?subject=Email change - Update Feedback link for datatwister"
                    class="text-blue-600 underline"
                  >{gettext("Email Everett")}</a> {gettext(
                    "to update your feedback thread.  Nothing else will be affected."
                  )}
                </p>
              </div>
              <div class="sm:col-span-2 flex flex-col sm:flex-row gap-2 items-start sm:items-center">
                <input
                  ...
                  value=""
                  maxlength="255"
                  class="w-full sm:w-72 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  {gettext("You only need to supply a password if you want to change it")}
                </p>
              </div>
              <div class="sm:col-span-2">
                <input
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 px-4 py-4 sm:px-6 gap-4 items-start">
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  {gettext("You only need to confirm your password if you changed it above")}
                </p>
              </div>
              <div class="sm:col-span-2">
                <input
