defmodule SambaWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `SambaWeb.Components.Carousel`
  project.
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/carousel
  ...
  import SambaWeb.Components.Image, only: [image: 1]
