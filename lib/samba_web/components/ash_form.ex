defmodule SambaWeb.AshForm do
  ...
  `Samba.Members.Member` resource, such as `name`, `email`, etc., based on the resource’s
  ...
  - SambaWeb.CoreComponents (for input and button components)
  ...
  def render(assigns) do
    ...
    <div class="m-4">
      <Phoenix.Component.form for={@form} phx-change="validate" phx-submit="save" phx-target={@myself}>
        ...
        <SambaWeb.CoreComponents.button>
          Submit
        </SambaWeb.CoreComponents.button>
