defmodule SambaWeb.Components.CheckboxField do
  @moduledoc """
  SambaWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
