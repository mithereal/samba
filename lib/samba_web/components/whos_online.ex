defmodule SambaWeb.Components.WhosOnline do
  ...
  defp role_color(1), do: "text-[#C97B01]"
  defp role_color(2), do: "text-[#C0C000]"
  defp role_color(3), do: ""
  defp role_color(4), do: "text-[#008000]"
  defp role_color(6), do: "text-[#9E8DA7]"
  defp role_color(5), do: "text-indigo-600 dark:text-indigo-400"
  # Falls back to parent text container styling
  defp role_color(_member), do: ""
end
