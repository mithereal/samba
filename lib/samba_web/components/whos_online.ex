defmodule SambaWeb.Components.WhosOnline do
  ...
  attr :users, :list,
       default: [
         ...
         %{id: 562_882, username: "LUZIE", role: :bot},
         ...
         %{id: 539_786, username: "Tapsr1", role: :premium},
         ...
         %{id: 206_842, username: "uncleblue99", role: :super_mod},
         %{id: 116_281, username: "VWSTORECHICK", role: :bot},
         %{id: 6393, username: "Walk Thru KO", role: :moderator}
       ]
      ...
      <div class="p-6 flex flex-col md:flex-row items-start md:items-center gap-6 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div class="flex-grow space-y-3 text-xs md:text-sm">
          ...
          <div class="text-gray-500 dark:text-gray-400 pt-1 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            ...
            users in chat right now. <.link navigate={~p"/sign-in"} > [ Please login to use chat ]</.link></span>
  ...
  # Role color matcher matching the legend definitions
  defp role_color(:admin), do: "text-[#C97B01]"
  defp role_color(:super_mod), do: "text-[#C0C000]"
  defp role_color(:moderator), do: "text-[#008000]"
  defp role_color(:bot), do: "text-[#9E8DA7]"
  defp role_color(:premium), do: "text-indigo-600 dark:text-indigo-400"
  defp role_color(_member), do: "" # Falls back to parent text container styling
end