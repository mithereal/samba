defmodule SambaWeb.Components.WhosOnline do
  ...
  attr :users, :list, default: [
                        %{id: 236365, username: "50COUPE'", role: :member},
                        %{id: 139910, username: "77kafer", role: :member},
                        %{id: 413034, username: "Angus II", role: :member},
                        ...
                        %{id: 392686, username: "dogballs666", role: :member},
                        %{id: 30866, username: "Eric&Barb", role: :member},
                        %{id: 42771, username: "fadler1", role: :member},
                        %{id: 375649, username: "fxr", role: :member},
                        %{id: 158664, username: "Graysvws", role: :member},
                        %{id: 424038, username: "heimlich", role: :admin},
                        %{id: 514841, username: "hobthebob", role: :member},
                        %{id: 361857, username: "jaconty", role: :member},
                        %{id: 9242, username: "jim", role: :admin},
                        %{id: 534515, username: "jim coe", role: :member},
                        %{id: 562882, username: "LUZIE", role: :member},
                        %{id: 560250, username: "Mark stacey", role: :member},
                        %{id: 449379, username: "mfw59", role: :member},
                        %{id: 379128, username: "Mr. Mike", role: :member},
                        %{id: 19131, username: "nathan3", role: :member},
                        %{id: 117785, username: "NJ John", role: :member},
                        %{id: 513324, username: "penalosap", role: :member},
                        %{id: 218828, username: "Q-Dog", role: :member},
                        %{id: 322628, username: "Racer Rick", role: :member},
                        %{id: 300442, username: "rhd914", role: :member},
                        %{id: 19710, username: "RJ'sVW", role: :member},
                        %{id: 60271, username: "rorrerhow", role: :member},
                        %{id: 9965, username: "stevo", role: :member},
                        %{id: 539786, username: "Tapsr1", role: :member},
                        %{id: 337723, username: "TDCTDI", role: :member},
                        %{id: 115578, username: "The Cheetle", role: :member},
                        %{id: 529457, username: "titolillas", role: :member},
                        %{id: 26966, username: "Transportation Emporium", role: :admin},
                        %{id: 206842, username: "uncleblue99", role: :member},
                        %{id: 116281, username: "VWSTORECHICK", role: :member},
    ...
    <div class="w-full mx-auto shadow-xl rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900/80 backdrop-blur-md">
      ...
      <div class="p-6 flex flex-col md:flex-row items-start md:items-center gap-6 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div class="flex-grow space-y-3 text-xs md:text-sm">
          <div>
            In total there are <span class="font-bold"><%= @stats.total_online %></span> users online :: <%= @stats.registered_count %> Registered, <%= @stats.hidden_count %> Hidden and <%= @stats.guest_count %> Guests<br>
            Most users ever online was <span class="font-bold"><%= @stats.max_online %></span> on <%= @stats.max_online_date %>
          </div>
            ...
            <span class="text-gray-600 dark:text-gray-400 leading-relaxed">
              <%= for {user, index} <- Enum.with_index(@users) do %>
                <.link
                  ...
                  class={[
                    "hover:underline",
                    user.role in [:admin, :super_mod] && "font-bold text-indigo-600 dark:text-indigo-400"
                  ]}
          ...
          <div class="text-gray-500 dark:text-gray-400 pt-1 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <span>There are <span class="font-bold text-gray-700 dark:text-gray-200"><%= @stats.chat_users %></span> users in chat right now. &nbsp;[ Please login to use chat ]</span>
      ...
      <div class="bg-gray-100 dark:bg-gray-800/80 px-6 py-3 border-t border-gray-300 dark:border-gray-700 text-xs flex flex-wrap items-center justify-center gap-4 text-gray-600 dark:text-gray-300">
        ...
        <.link navigate={~p"/premium_membership"} class="font-semibold underline text-indigo-600 dark:text-indigo-400">Premium Member</.link>
      </div>
    </div>
    """
  end
